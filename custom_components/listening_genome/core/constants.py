...
# Home Assistant namespaces custom-integration logs by package, so this is the name that
# appears in the HA log and the one a user sets a level for in logger: config.
LOGGER = logging.getLogger("custom_components.listening_genome")
